            ...
            <ul class="participants-list">
              ${participants.length > 0 ? participants.map((participant) => `
                <li class="participant-chip">
                  ...
                  <button class="participant-remove-btn" data-activity="${name}" data-email="${participant}" aria-label="Remove ${participant}" title="Remove ${participant}">✕</button>
                </li>
              `).join("") : '<li class="empty">No participants yet</li>'}
            </ul>
          </div>
        `;
